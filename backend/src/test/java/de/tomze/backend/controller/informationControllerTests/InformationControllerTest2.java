...
class InformationControllerTest2 {
    ...
    public void adminShouldDeleteSpecialInfo() {
        ...
        ResponseEntity<InformationToAppDto> response = restTemplate.exchange(url() + "/3", HttpMethod.DELETE,  httpEntity, InformationToAppDto.class);
